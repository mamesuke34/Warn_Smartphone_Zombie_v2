...
public class MainActivity extends Activity implements Runnable, SensorEventListener, OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Study_Mode = (Button)findViewById(R.id.study_mode);
        Study_Mode.setOnClickListener(this);

        message= (TextView)findViewById(R.id.status2);
    ...
    public void weka() {
        try {
            ...
            if (result == 0.0){
                ...
                final ImageView image = (ImageView) findViewById(R.id.status_image);
